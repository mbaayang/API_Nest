...
__decorate([
    (0, class_validator_1.IsEmail)({}, { message: "Format de l'email invalide" }),
...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: "RFID requis pour l'accés à la plateforme" }),
    __metadata("design:type", String)
], CreateUserDto.prototype, "rfId", void 0);
